          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-3/5 text-left">
              ...
              <div className="space-y-6 text-lg text-white/80 leading-relaxed">
                <p>
                  Localizada em ponto estratégico da cidade, nossa loja oferece
                  uma variedade completa de tintas e soluções para pintura
                ...
                <p>
                  ...
                  e prezamos pelo atendimento de qualidade, buscando sempre
                  ajudar o cliente a encontrar o melhor custo-benefício para seu
                  projeto.
                </p>
                <p>
                  Nossa equipe é{" "}
